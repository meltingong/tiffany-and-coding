...
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,1,1,'test1');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,2,1,'test1');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,3,2,'test1');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,4,3,'test1');
--test2 님이 6번 1개,8번 1개,10번 2개 제품담기 
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,6,1,'test2');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,8,1,'test2');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,10,2,'test2');
--test1 님이 11번 1개,13번 1개,15번 2개 제품담기 
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,11,1,'test3');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,13,1,'test3');
insert into cart(cart_no,cart_qty,p_no,userId) values(cart_cart_no_seq.nextval,15,2,'test3');
...
values(room_room_no_SEQ.nextval,'테스트1번방','test1','test2');
insert into room(room_no,room_name,from_id,to_id)
values(room_room_no_SEQ.nextval,'테스트2번방','test1','test3');

/***********채팅 메시지*****************/
insert into chatmsg(msgNo,msgcontent,msgsendtime,msgread,userid,room_no)
values(chatMsg_msgNo_SEQ.nextval,'안녕',sysdate,0,'test1',1);
insert into chatmsg(msgNo,msgcontent,msgsendtime,msgread,userid,room_no)
values(chatMsg_msgNo_SEQ.nextval,'나야',sysdate,0,'test1',1);
insert into chatmsg(msgNo,msgcontent,msgsendtime,msgread,userid,room_no)
